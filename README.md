...
| 4.0 | 07/07/2025  | Valdizán, Fernández, Rodrigo, Diaz. De Las Casas | Cuarta versión del informe  |
...
|:--------------------| :---- |
| Roy Fernández Remón | Realización del capitulo 2 |
...
- [Capítulo II: Requirements Elicitation \& Analysis](#capítulo-ii-requirements-elicitation--analysis)
  - [2.1. Competidores](#21-competidores)
    - [2.1.1. Análisis copetitivo](#211-análisis-copetitivo)
  ...
  - [2.2. Entrevistas](#22-entrevistas)
    ...
    - [Cliente](#cliente)
    - [Dueño de tienda o encargado de feria eco-friendly](#dueño-de-tienda-o-encargado-de-feria-eco-friendly)
    - [Productor de productos sostenibles](#productor-de-productos-sostenibles)
    - [2.2.2. Registro de entrevistas](#222-registro-de-entrevistas)
    - [2.2.3. Análisis de entrevistas](#223-análisis-de-entrevistas)
  - [2.3. Needfinding](#23-needfinding)
    - [2.3.1. User Personas](#231-user-personas)
    - [2.3.2. User Task Matrix](#232-user-task-matrix)
    - [**Principales diferencias y coincidencias entre los segmentos:**](#principales-diferencias-y-coincidencias-entre-los-segmentos)
...
- [Capítulo III: Requirements Specification](#capítulo-iii-requirements-specification)
  ...
  - [👨‍🌾 Segmento 1: Agricultores Orgánicos](#-segmento-1-agricultores-orgánicos)
  ...
  - [🛒 Segmento 2: Consumidores](#-segmento-2-consumidores)
    ...
    - [User Story 6](#user-story-6-1)
    - [User Story 7](#user-story-7-1)
...
- [Capítulo IV: Product Design](#capítulo-iv-product-design)
  - [4.1. Style Guidelines](#41-style-guidelines)
    ...
    - [**Tono y comunicación**](#tono-y-comunicación)
  ...
  - [4.3. Landing Page UI Design](#43-landing-page-ui-design)
    ...
    - [4.3.1. Landing Page Mockup](#431-landing-page-mockup)
...
- [**Capítulo V: Product Implementation, Validation \& Deployment.**](#capítulo-v-product-implementation-validation--deployment)
  - [5.1. Software Configuration Management.](#51-software-configuration-management)
    ...
    - [**Develop branch**](#develop-branch)
      - [Notación: develop](#notación-develop)
    - [**Release branch**](#release-branch)
      - [Notación: release](#notación-release)
    - [**Feature branch**](#feature-branch)
      - [Notación: release](#notación-release-1)
    - [**Hotfix branch**](#hotfix-branch)
      - [Notación: hotfix](#notación-hotfix)
    - [**Support branch**](#support-branch)
    - [**Conventional Commits**](#conventional-commits)
    - [5.1.3. Source Code Style Guide \& Conventions.](#513-source-code-style-guide--conventions)
    - [5.1.4. Software Deployment Configuration.](#514-software-deployment-configuration)
    - [5.1.4. Software Deployment Configuration.](#514-software-deployment-configuration-1)
...
| Criterio Especifico | Acciones Realizadas | Conclusiones |
| :---- | :---- | :---- |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | Diaz Gutierrez, Henry **TF:** En esta entrega me encargué de realizar el sistema de perfiles y estadisticas .Ademas logre desplegar el landing page | En conclusion todos trabajamos de manera conjunta y de esa manera se logro culminar a tiempo el TF. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | Diaz Gutierrez, Henry  **TF:** Logre culminar y cumplir con mis tareas asignadas y ademas pude realizar ciertos cambios al documento con cierta anticipacion.|En conclusion todos los integrantes del proyecto culminaron con su trabajo asignado con puntualidad, con las metas y objetivos establecidos para este entregable. | 

| Criterio Especifico | Acciones Realizadas | Conclusiones |
| :---- | :---- | :---- |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | De Las Casas Latour, Sebastián **TB1:** En esta entrega me encargué de desarrollar todo el capítulo 5 del informe.  **TP:** En esta entrega me encargué de Actualizar y añadir secciones nuevas y pertinentes en el capítulo 5 del informe. **TB2:** Me encargué prioritariamente en la actualización del informe y el sprint 3 **TF:** Me volví a dedicar más que nada a la redacción y organización del informe final| En conclusion todos trabajamos de manera conjunta y de esa manera se logro culminar a tiempo el trabajo. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | De Las Casas Latour, Sebastián  **TB1:** Pude cumplir con las labores asignadas de manera efectiva y a tiempo. **TP:** Pude cumplir con las labores asignadas de manera efectiva y a tiempo. **TB2:** Colaboré ayudando a redactar partes del informe y en algunas partes del desarrollo del backend **TF:** Ayude a mis compañeros al encargarme de la mayoría de arreglos del informe |En conclusion todos los integrantes del proyecto culminaron con su trabajo asignado con puntualidad, con las metas y objetivos establecidos para este entregable. |

| Criterio Específico | Acciones Realizadas | Conclusiones |
|---------------------|---------------------|--------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | Sosa Soto, Oskar Rodrigo TF: En esta entrega me encargué del desarrollo del backend, implementando la lógica del sistema y asegurando su correcto funcionamiento. Asimismo, realicé ajustes en el frontend para mejorar la presentación y asegurar la integración entre ambas partes del proyecto. | En conclusión, todos trabajamos de manera colaborativa y coordinada, lo que permitió cumplir con las tareas asignadas y entregar el proyecto final a tiempo. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | Sosa Soto, Oskar Rodrigo TF: Asumí la responsabilidad de tareas clave relacionadas al backend y al ajuste del frontend, cumpliendo con los objetivos establecidos para esta entrega. Colaboré con mis compañeros resolviendo dudas técnicas y asegurando que la integración general del sistema fuera efectiva. | A pesar de los retos presentados, todos los integrantes del grupo trabajaron con responsabilidad y compromiso, logrando cumplir con los objetivos propuestos y entregando un producto final funcional y completo. |
...
| Criterio Especifico | Acciones Realizadas | Conclusiones |
| :---- | :---- | :---- |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | Roy Fernández Remón **TB2:** En esta entrega me encargué de desarrollar el backend para el desarrollo de registro e inicio de sesión. | Se puede concluir que cada integrante Interpretó de la mejor manera los mockups de las páginas para realizar sus vistas. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | Roy Fernández Remón  **TB2:** Cumplí con mis tareas asignadas con cierta dificultad y logré cumplir con la gran mayoría de metas planteadas | A pesar de las dificultades, todos los integrantes del proyecto aportaron con puntialidad con las metas y objetivos establecidos para este entregable | 

| Criterio Especifico | Acciones Realizadas | Conclusiones |
| :---- | :---- | :---- |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | Roy Fernández Remón **TF:** En esta entrega me encargué de actualizar el registro e inicio de sesion y ayudar a mis compañeros respecto a algunos problemas con el backend, a la realizacion del informe y a completar los pasos finales del frontend. | Se puede concluir que cada integrante Interpretó de la mejor manera cada sección de este proyecto. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | Roy Fernández Remón  **TP1:** Cumplí con mis tareas asignadas con cierta dificultad y logré cumplir con la gran mayoría de metas planteadas | A pesar de las dificultades, todos los integrantes del proyecto aportaron con puntialidad con las metas y objetivos establecidos para este entregable | 
...
|Roy Fernández Remón | Me llamo Roy Fernández Remón y estudio la carrera de Ingeniería de Software, actualmente estoy en el 6to ciclo de la carrera. Soy una persona dedicada a mis estudios y trabajos, y me gusta ser responsable con las actividades académicas.  |
...
![image](https://github.com/user-attachments/assets/d885bf83-c324-444a-9805-fa3fe309ea2d)

 Segmento 2: Consumidores que compran orgánicos

 ![image](https://github.com/user-attachments/assets/096f1a19-487b-4fbf-8857-720d09f233df)


## 3.2. User Stories.
Dentro del apartado de historias de usuario, explicaremos en detalle las diferentes necesidades y requerimientos de nuestros clientes y de los productores orgánicos. Cada historia de usuario representará un caso de uso o una función que la plataforma debe implementar para cumplir con nuestro propósito fundamental: ofrecer una solución integral para la gestión de la logística ecológica.

## 👨‍🌾 Segmento 1: Agricultores Orgánicos

### User Story 1
**Como** agricultor orgánico,  
**quiero** acceder a una plataforma especializada en transporte ecológico,  
**para** distribuir mis productos sin contaminar y de forma eficiente.

**Escenario 1:**  
- **Dado** que necesito enviar productos a una feria ecológica,  
- **cuando** accedo a Greenlogist,  
- **entonces** visualizo opciones de transporte que utilizan vehículos sostenibles.

**Escenario 2:**  
- **Dado** que busco reducir mi huella de carbono,  
- **cuando** selecciono un servicio de envío,  
- **entonces** puedo ver el impacto ambiental de cada opción de transporte.

---

### User Story 2
**Como** agricultor orgánico,  
**quiero** registrar fácilmente mis productos,  
**para** que puedan ser distribuidos correctamente.

**Escenario 1:**  
- **Dado** que ingreso a mi perfil como productor,  
- **cuando** selecciono “Agregar producto”,  
- **entonces** puedo completar datos como tipo, peso, y disponibilidad.

**Escenario 2:**  
- **Dado** que ya registré productos anteriormente,  
- **cuando** deseo duplicar o editar uno,  
- **entonces** puedo modificarlo sin necesidad de ingresar toda la información de nuevo.

---

### User Story 3
**Como** agricultor orgánico,  
**quiero** ver estadísticas de mis envíos,  
**para** optimizar mi producción y distribución.

**Escenario 1:**  
- **Dado** que he realizado varios envíos,  
- **cuando** accedo al panel de métricas,  
- **entonces** puedo visualizar los destinos más frecuentes y tiempos de entrega.

**Escenario 2:**  
- **Dado** que tengo distintos productos,  
- **cuando** filtro por tipo de producto,  
- **entonces** obtengo estadísticas específicas de cada uno.

---

### User Story 4
**Como** agricultor orgánico,  
**quiero** conectarme con transportistas ecológicos verificados,  
**para** asegurar la calidad y puntualidad del envío.

**Escenario 1:**  
- **Dado** que estoy eligiendo un transportista,  
- **cuando** reviso su perfil,  
- **entonces** puedo ver su calificación y comentarios de otros productores.

**Escenario 2:**  
- **Dado** que tengo una urgencia,  
- **cuando** uso el filtro “disponibilidad inmediata”,  
- **entonces** solo se muestran transportistas activos en tiempo real.

---

### User Story 5
**Como** agricultor orgánico,  
**quiero** recibir notificaciones del estado del envío,  
**para** mantenerme informado del recorrido de mis productos.

**Escenario 1:**  
- **Dado** que mi envío ha sido recogido,  
- **cuando** entra en tránsito,  
- **entonces** recibo notificaciones automáticas en mi celular.

**Escenario 2:**  
- **Dado** que el pedido ya fue entregado,  
- **cuando** accedo a la app,  
- **entonces** puedo ver una confirmación y detalles de la entrega.

---

### User Story 6
**Como** agricultor orgánico,  
**quiero** que mi perfil sea visible públicamente,  
**para** ganar reputación y atraer más clientes.

**Escenario 1:**  
- **Dado** que mi cuenta está verificada,  
- **cuando** alguien navega productos orgánicos,  
- **entonces** mi perfil aparece como productor destacado si tengo buena calificación.

**Escenario 2:**  
- **Dado** que deseo compartir más sobre mi producción,  
- **cuando** actualizo mi perfil,  
- **entonces** puedo agregar fotos, historia y certificaciones ecológicas.

---

### User Story 7
**Como** agricultor orgánico,  
**quiero** elegir horarios y días de recojo,  
**para** planificar mejor según mi calendario de cosecha.

**Escenario 1:**  
- **Dado** que estoy programando un envío,  
- **cuando** elijo la fecha,  
- **entonces** solo me aparecen horarios disponibles de transportistas.

**Escenario 2:**  
- **Dado** que necesito modificar el horario,  
- **cuando** edito el envío ya agendado,  
- **entonces** puedo cambiarlo con al menos 24 horas de anticipación.
...
**quiero** saber que el delivery es sostenible,  
**para** mantener coherencia con mis valores ecológicos.

**Escenario 1:**  
- **Dado** que estoy revisando mi carrito de compra,  
- **cuando** selecciono una opción de envío,  
- **entonces** puedo ver el nivel de sostenibilidad de cada transporte.

**Escenario 2:**  
- **Dado** que recibí mi pedido,  
- **cuando** reviso el detalle,  
- **entonces** se muestra cuánto CO₂ se ahorró con el transporte verde.

---

### User Story 2
**Como** consumidor,  
**quiero** ver perfiles detallados de los productores,  
**para** saber a quién estoy apoyando con mi compra.

**Escenario 1:**  
- **Dado** que navego entre productos,  
- **cuando** hago clic en un productor,  
- **entonces** veo su biografía, fotos y métodos de producción.

**Escenario 2:**  
- **Dado** que me gustó un productor,  
- **cuando** lo marco como favorito,  
- **entonces** puedo recibir notificaciones de nuevos productos o promociones.

---

### User Story 3
**Como** consumidor,  
**quiero** hacer pedidos fácilmente desde el celular,  
**para** no perder tiempo ni complicarme.

**Escenario 1:**  
- **Dado** que accedo a Greenlogist desde mi teléfono,  
- **cuando** inicio sesión,  
- **entonces** puedo buscar productos, agregarlos al carrito y pagar en minutos.

**Escenario 2:**  
- **Dado** que estoy en una zona con baja señal,  
- **cuando** entro a la app,  
- **entonces** accedo al modo de carga ligera para seguir navegando.
...
**Escenario 1:**  
- **Dado** que mi pedido ha sido aceptado,  
- **cuando** cambia de estado,  
- **entonces** recibo alertas push en mi celular.

**Escenario 2:**  
- **Dado** que tengo un pedido programado,  
- **cuando** se acerca la hora de entrega,  
- **entonces** recibo un recordatorio con la ubicación del transportista.

---

### User Story 5
**Como** consumidor,  
**quiero** dejar reseñas,  
**para** compartir mi experiencia y apoyar a buenos productores.

**Escenario 1:**  
- **Dado** que completé una compra,  
- **cuando** reviso el historial,  
- **entonces** tengo la opción de calificar y escribir un comentario.

**Escenario 2:**  
- **Dado** que me llegó un producto en mal estado,  
- **cuando** envío una reseña negativa,  
- **entonces** el sistema me permite adjuntar evidencia para revisión.

---

### User Story 6
**Como** consumidor,  
**quiero** filtrar productos por tipo, origen o precio,  
**para** encontrar más fácilmente lo que busco.

**Escenario 1:**  
- **Dado** que hay una gran variedad de productos,  
- **cuando** aplico filtros,  
- **entonces** los resultados se actualizan al instante.

**Escenario 2:**  
- **Dado** que ya sé qué quiero,  
- **cuando** escribo en la barra de búsqueda,  
- **entonces** la plataforma me sugiere resultados relevantes automáticamente.

---

### User Story 7
**Como** consumidor ecológico,  
**quiero** ver el impacto ambiental positivo de mis compras,  
**para** sentirme motivado a seguir consumiendo responsablemente.

**Escenario 1:**  
- **Dado** que realicé varias compras,  
- **cuando** accedo a mi perfil,  
- **entonces** veo un resumen de CO₂ ahorrado y kilómetros sostenibles.

**Escenario 2:**  
- **Dado** que deseo compartir mi impacto,  
- **cuando** hago clic en “Compartir impacto”,  
- **entonces** puedo publicar mis estadísticas en redes sociales.
...
La web app con el backend implementado y funcionando:
